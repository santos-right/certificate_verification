...
<body class="bg-gradient-bg-gray-600 pt-5">
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="models/register.php" method="POST">
                                <?php
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="username" id="exampleLastName"
                                ...
                                <button type="register" name="registerbtn" class="btn btn-primary btn-user btn-block">
                                    Register Account
                                </button>
                            </form>
                        </div>
